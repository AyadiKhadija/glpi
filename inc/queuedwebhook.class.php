...
class QueuedWebhook extends CommonDBTM {
   ...
   function prepareInputForAdd($input) {
      ...
      if (!isset($input['date_send']) || empty($input['date_send'])) {
         $input['date_send'] = $_SESSION["glpi_currenttime"];
      }
      $input['sent_try'] = 0;
   ...
   function showForm($ID, $options = []) {
      ...
      echo "<td>".Html::convDateTime($this->fields['date_send'])."</td>";
      echo "</tr>";

      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Send date')."</td>";
      echo "<td>".Html::convDateTime($this->fields['date_sent'])."</td>";
